...
const DialougeRemainingUnits = forwardRef(({
    onClose,
    data,
    label,
    setScroll
  ...
  function handleClientView(e, field) {
    ...
    const MyItemRender = (props) => {
        ...
        return (
            ...
            >
                <div onClick={(e) => handleClientView(e, item)} className={ "col-3  cursor-pointer text-theme"}>{item.clientName}</div>
                <div className={ "col-3"}>{item.remainingUnits}</div>
...
export default DialougeRemainingUnits