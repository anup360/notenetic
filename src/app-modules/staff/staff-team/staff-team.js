...
const StaffTeam = ({ available, assigned }) => {
  ...
  const handleToolBarClick = async (e) => {
    ...
    try {
      await apiHelper.postRequest(API_URLS.ASSIGN_STAFF_TO_STAFF, body);
      setLoading(false);
    } catch (error) {
  ...
  return (
    <div className="container">
      ...
      <h4 className="address-title text-grey pb_20">
        <span className="f-24">Staff Team</span>
      </h4>
      <div className="col-lg-4 col-md-6 mb-3">
        <div className="content-search-filter">
          ...
          <Input
            ...
            placeholder="Search Availabe Staff"
        ...
        <div className="col k-pr-2">
          ...
          <ListBox
            ...
            data={filterBy(state.available, [
              { field: "staffName", operator: "contains", value: filter },
            ])}
            textField="staffName"
            ...
            toolbar={() => {
              return (
                <>
                  {userAccessPermission[permissionEnum.MANAGE_STAFF_TEAM] &&
                    <ListBoxToolbar
                      tools={[
                        "transferTo",
                        "transferFrom",
