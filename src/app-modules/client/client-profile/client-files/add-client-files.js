...
const AddStoredDocuments = () => {
  ...
  const saveDocument = () => {
    ...
    ApiHelper.multipartPostRequest(ApiUrls.POST_CLIENT_STORED_DOCUMENT, data)
      .then((result) => {
        setLoading(false);
    ...
    <div className="d-flex flex-wrap">
      ...
      <div className="col-md-9 col-lg-10">
        ...
        <div className="col mt-5 ">
          ...
          <div className="footer-composer mt-2 col-lg-5 col-md-6 col-12">
            <span className="position-relative">
              ...
              <div className="d-flex mt-5">
                ...
                <div className="right-sde-grey mx-3">
                  <button
...
export default AddStoredDocuments;
